"use client";
import bg2 from "@/assets/images/backgrounds/page-header-bgInternship.jpg";
import bg31 from "@/assets/images/MobileTopBanners/Internship.gif";
...
export default PageHeaderInternship;
