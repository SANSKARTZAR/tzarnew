            ...
            >
              ...
              <div className="comment-form__input-boxpop" autoComplete="On">
                <div className="FormContainer">
                  <Row>
                    ...
                    <Col xl={12}>
                      <select id="position" name="position" required>
                        ...
                        <option value="Software Engineer">Web Developer</option>
                        ...
                        <option value="UI/UX Designer">Graphic Designer</option>
                      </select>
                    </Col>
                    ...
                    <Col xl={12}>
                      <div className="formlefttxtpop">
                        <input
                          ...
                          required
                        />
                        <label className="form-dec">
                          By submitting this form, you agree to be contacted via
                          email or phone regarding your job enquiry. Privacy Policy.
                        </label>
                      </div>
                    </Col>
                  </Row>
                  ...
                  <div>
                    <button
                      className="button-50 comment-form__btn"
                      type="submit"
